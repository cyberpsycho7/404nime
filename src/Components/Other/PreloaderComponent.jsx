...
const PreloaderComponent = ({isLoaded, isSearch}) => {
  return (
    <div className={`${isSearch ? "py-14 w-[1030px] 1320res:w-[820px] 1100res:w-[636px] 900res:w-full" : "w-full h-[calc(100vh-91px)]"} flex flex-col justify-center items-center duration-300 ${!isLoaded ? "opacity-0" : ''}`}>
